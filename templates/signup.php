...
<nav>
    <ul><li id="signin"><a href="login.php?page=signin">Sign in</a></li><li id="signup">Sign up</li></ul>
</nav>
<header>
    <h1>Delakilo</h1>
</header>
<main>
    ...
    <form action="utils/loginHandler.php" method="POST" onsubmit="submitForm2Data()">
        <h2>Register</h2>
        <ul>
            <li>
